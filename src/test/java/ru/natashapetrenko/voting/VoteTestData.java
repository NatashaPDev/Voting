...
public class VoteTestData {
    ...
    public static final Vote VOTE1 = new Vote(VOTE1_ID, of(2018, Month.JANUARY, 1, 10, 0, 0), RESTAURANT1, USER);
    public static final Vote VOTE2 = new Vote(VOTE1_ID + 1, of(2018, Month.JANUARY, 1, 10, 0, 0), RESTAURANT1, ADMIN);
    public static final Vote VOTE3 = new Vote(VOTE1_ID + 2, of(2018, Month.JANUARY, 2, 10, 0, 0), RESTAURANT1, USER);
    public static final Vote VOTE4 = new Vote(VOTE1_ID + 3, of(2018, Month.JANUARY, 2, 10, 0, 0), RESTAURANT2, ADMIN);


    public static final List<Vote> VOTES = Arrays.asList(VOTE3, VOTE4, VOTE1, VOTE2);

    public static Vote getCreated() {
        return new Vote(null, of(2018, Month.JANUARY, 3, 10, 0, 0), RESTAURANT1, USER);
    }

    public static Vote getUpdated() {
        return new Vote(VOTE1_ID, VOTE1.getDateTime(), RESTAURANT1, USER);
    }
